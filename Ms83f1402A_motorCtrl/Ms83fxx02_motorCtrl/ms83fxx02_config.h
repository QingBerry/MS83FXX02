...
#define Battery_Threshold_1_3_4V		((uint16_t)686)//686  //415
#define Battery_Threshold_1V			((uint16_t)512)//512  //301
#define Battery_Threshold_1_2V			((uint16_t)614)
#define Battery_Threshols_0_9V			((uint16_t)460)//460  //271
