...
void Battery_Detect(void)
{
	...
	{
#if 1
		if(adc_data < Battery_Threshols_2_8V)
		{
...
#endif
		else if(adc_data < Battery_Threshold_3_1V)
		{
		...
		else
		{
			...
			{
				if(adc_data > Battery_Threshold_3_2V)
				{
	...
	else 
	{
		if(mode == CHARGE_MODE)
		{
			...
			if(adc_data > Battery_Threshold_3_4V)
			{
